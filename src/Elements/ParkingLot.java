...
import abstractclasses.ExitPoint;
...
public class ParkingLot implements ObservableInterface {
	...
	public static void modifyParkingRates(double firstRate, double secondRate, double thirdRate) {
		Cashier.firstRate = firstRate;
		Cashier.secondRate = secondRate;
		Cashier.thirdRate = thirdRate;
	}
}
